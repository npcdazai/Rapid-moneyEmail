    ...
    return (
      <Shell>
        ...
        <p className="login-sub">
          This page needs a valid reset-password link. Ask an administrator to send a new one.
        </p>
  ...
  if (done) {
    return (
      <Shell>
        ...
        <p className="login-sub">Your password has been updated. You can now sign in.</p>
        <a className="login-submit" href="/login" style={{ textDecoration: "none" }}>
          Continue to sign in
        </a>
      </Shell>
